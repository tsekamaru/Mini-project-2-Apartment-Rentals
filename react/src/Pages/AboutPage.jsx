...
const AboutPage = () => {
  ...
  return (
    <div className="about-container">
      ...
      <p>
        This is an Airbnb clone created as part of our project to learn full-stack development. The
        application allows users to browse and book apartments, showcasing modern UI design and
